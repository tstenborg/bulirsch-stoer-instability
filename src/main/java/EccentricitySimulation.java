...
public final class EccentricitySimulation {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        InputStream inputStream = EccentricitySimulation.class
            .getResourceAsStream(DATA_FILE);
        if (inputStream == null) {
            throw new IllegalArgumentException("Data file " + DATA_FILE
        ...
        ScatterTrace traceJupExp = ScatterTrace.builder(x, yJupCalc)
            ...
            .line(Line.builder()
                .color(HEX_BLACK).dash(Line.Dash.DASH_DOT).build())
            .build();
        //
        ...
        String plotTitle = new java.lang.String(
            "Eccentricity Simulation Over 200,000 Years");
        ...
        Plot.show(new Figure(layoutRK,
            new Trace[] {
                traceJupExp, traceSatExp, traceJupSimRK, traceSatSimRK}));
        ...
        Plot.show(new Figure(layoutBS,
            new Trace[] {
                traceJupExp, traceSatExp, traceJupSimBS, traceSatSimBS}));
    }
}
